...
# Files needed :
  ...
  # HIA_replicate.rds : results of HIA outputs for 1000 replications of all diseases
  # HIA_replicate_age.rds : results of HIA outputs for 1000 replications per age of all diseases 
