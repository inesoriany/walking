...
export(burden_replicate_age, here("output", "RDS", "Log linear", "logHIA_1000replicate_per_age.rds"))
...
export(burden_replicate, here("output", "RDS", "Log linear", "logHIA_1000replicate.rds"))
...
burden_replicate <- import(here("output", "RDS", "Log linear", "logHIA_1000replicate.rds"))
...
for (out in outcome_vec){
  ...
  # Export results 
export(HIA_per_disease_Rubin, here("output", "Tables", "Log linear", "HIA_per_disease_Rubin.xlsx"))
...
for (out in outcome_vec){
  ...
  # Export results 
export(HIA_all_disease, here("output", "Tables", "Log linear", "HIA_global.xlsx"))
...
for (out in outcome_vec){
  ...
  # Export results 
export(HIA_all_disease_Rubin, here("output", "Tables", "Log linear", "HIA_global_Rubin.xlsx"))
...
export(reduc_mortality_risk_IC, here("output", "Tables", "Log linear", "reduc_mortality_risk.xlsx"))
...
export(unit_value_2019, here("output", "Tables", "Log linear", "1km_value_1000replicate.xlsx"))
...
# Export : economic value of 1 km walked per scenario
export(unit_soc_value_2019, here("output", "Tables", "Log linear", "1km_soc_value_1000replicate.xlsx"))
...
export(euro_unit_duration_2019, here("output", "Tables", "Log linear", "1€_km_duration_1000replicate.xlsx"))
...
# Export : Calculate distance and duration to save 1€ of medical costs in 2019
export(soc_euro_unit_duration_2019, here("output", "Tables", "Log linear", "soc_1€_km_duration_1000replicate.xlsx"))
